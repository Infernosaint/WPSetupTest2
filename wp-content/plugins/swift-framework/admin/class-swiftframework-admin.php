	...
	public function swift_framework_about_content() {
	  ?>
		...
		<div class="about-content">
			<h3>Latest Update (v1.65)</h3>
			<p></p>
			<ul>
				<li>Temporary fix for image caption, reverted to a textfield input until html input is resolved </li>
			</ul>
			<h3>Previous Update (v1.64)</h3>
			<p></p>
			<ul>
				<li>Fixed progress bar styling</li>
				<li>Fixed stroke-to-fill button styling</li>
				<li>Fixed issue with page builder options not showing when certain requirements were met</li>
				<li>Fixed bootstrap conflict</li>
				<li>Fixed issue with image caption formatting</li>
				<li>Removed unecessary admin script from loading</li>
			</ul>
			<p></p>
		</div>
